...
function SETTING(setting_data, booking_package_dictionary, webApp) {
	...
	this._javascriptForUser = 1;
	if (setting_data.javascriptForUser != null) {
		
		this._javascriptForUser = parseInt(setting_data.javascriptForUser);
	...
	**/
	...
	this.loadTabFrame = function(){
		...
		if (object._javascriptForUser == 0) {
			
			delete menuList.javascriptLink;
	...
	this.syncPanel = function(){
		...
		document.getElementById("save_bookingSync").onclick = function(){
        	...
        	var input = new Input(object._debug);
        	object._console.log(inputData);
        	var valueList = {};
	...
	this.javascriptPanel = function() {
		...
		var css_textarea = document.getElementById("javascript_booking_package");
