    function Hotel(currency, weekName, dateFormat, positionOfWeek, startOfWeek, booking_package_dictionary, debug) {
    ...
    Hotel.prototype.setGuests = function(key, index, person){
        ...
        var object = this;
        object._console.log("key " + key + " index = " + index + " person = " + person);
