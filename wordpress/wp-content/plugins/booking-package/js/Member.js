    ...
    Booking_Package_Member.prototype.bookingDetails = function(key, reservationData, callback) {
        ...
        if (parseInt(reservationData.cancel) == 1) {
            ...
            cancelButton.onclick = function() {
                ...
                object._console.log(reservationData);
                var post = {nonce: object._nonce, action: object._action, mode: 'cancelUserBooking', key: reservationData.key, token: reservationData.cancellationToken, status: 'canceled', user_id: setting.current_member_id, sendEmail: 1};
