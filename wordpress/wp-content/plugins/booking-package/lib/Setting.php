        ...
        public function getElementForCalendarAccount(){
            ...
            $calendarAccount = array(
                ...
                **/
                ...
                'refuseCancellationOfBooking' => array('key' => 'refuseCancellationOfBooking', 'name' => __('Status to approve cancellation of booking', $this->pluginName).":", 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 1, 'option' => 0, 
                    'valueList' => array(
                ...
                'servicesPage' => array('key' => 'servicesPage', 'name' => __('Services page for front-end', $this->pluginName), 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 0, 'option' => 0, 'message' => __('Add "booking-package" to the name and "front-end" to the value on the Custom Fields in the Pages.', $this->pluginName), 'valueList' => array()),
                'calenarPage' => array('key' => 'calenarPage', 'name' => __('Calendar page for front-end', $this->pluginName), 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 0, 'option' => 0, 'message' => __('Add "booking-package" to the name and "front-end" to the value on the Custom Fields in the Pages.', $this->pluginName), 'valueList' => array()),
                'schedulesPage' => array('key' => 'schedulesPage', 'name' => __('Schedules page for front-end', $this->pluginName), 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 0, 'option' => 0, 'message' => __('Add "booking-package" to the name and "front-end" to the value on the Custom Fields in the Pages.', $this->pluginName), 'valueList' => array()),
                'visitorDetailsPage' => array('key' => 'visitorDetailsPage', 'name' => __('Visitor details page for front-end', $this->pluginName), 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 0, 'option' => 0, 'message' => __('Add "booking-package" to the name and "front-end" to the value on the Custom Fields in the Pages.', $this->pluginName), 'valueList' => array()),
                'thanksPage' => array('key' => 'thanksPage', 'name' => __('Booking completed page for front-end', $this->pluginName), 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 0, 'option' => 0, 'message' => __('Add "booking-package" to the name and "front-end" to the value on the Custom Fields in the Pages.', $this->pluginName), 'valueList' => array()),
                'redirectPage' => array('key' => 'redirectPage', 'name' => __('Redirect to another page without displaying the booking completion page', $this->pluginName), 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 0, 'option' => 0, 'message' => __('Add "booking-package" to the name and "front-end" to the value on the Custom Fields in the Pages.', $this->pluginName), 'valueList' => array()),
