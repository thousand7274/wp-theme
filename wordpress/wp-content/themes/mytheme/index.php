  ...
  <main>
    ...
    <div class="topics">
      <div class="topics__info">
        <h2>新着情報</h2>
        <dl>
          <dt><i class="fas fa-angle-right"></i>20190101</dt>
          <dd>新着情報の内容が入ります。</dd>
        </dl>
        <dl>
          <dt><i class="fas fa-angle-right"></i>20190101</dt>
    ...
    <div class="desc">
      <div class="desc__img">
        <img src="<?php echo get_template_directory_uri(); ?>/img/02.jpg" alt="四つ手小屋" width="700"></div>
      <div class="desc__text">
        <div class="desc__title"><span>よ</span>うこそ、四つ手小屋 近藤へ</div>
